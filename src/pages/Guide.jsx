    ...
    const steps = [
        {
            ...
            tips: [
                ...
                "お気に入りの服を見本にして、そのサイズをご自身のぬいぐるみの項目に入力するのも一つの方法です"
            ]
        },
        {
            number: 2,
        ...
        },
        {
            ...
            desc: "自慢の着こなしを「公開」しましょう。特に手作りの場合は、参考にした型紙のURLを貼ることで「製作レポート」として繋がり、他のオーナーさんの創作意欲を刺激します。",
            tips: [
        ...
        },
        {
            ...
            tips: [
                ...
                "『製作レポート』を見れば、同じ型紙でも生地やアレンジでどう変わるか一目瞭然です"
            ]
        }
    ];
