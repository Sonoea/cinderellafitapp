                    ...
                    <div className={`space-y-4 transition-opacity duration-300 ${!image ? '' : ''} `}>
                        <div className="space-y-4">
                            ...
                            <div className="flex items-center justify-between bg-orange-50/50 p-3 rounded-xl border border-orange-100/50">
                                ...
                                <label className={`relative inline-flex items-center ${!formData.isPublic ? 'cursor-not-allowed' : 'cursor-pointer'}`}>
                                    <input
                                        type="checkbox"
                                    ...
                                    />
                                    <div className={`w-11 h-6 ${!formData.isPublic ? 'bg-gray-100' : 'bg-orange-200'} peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-orange-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-orange-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-orange-600`}></div>
                                </label>
                            </div>
