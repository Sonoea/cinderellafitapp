...
const ALLOWED_ORIGINS = [
    'https://cinderellafitapp.vercel.app',
    'http://localhost:5173',
    'http://localhost:3000',
];
app.use(cors({
    origin: (origin, callback) => {
        // Pass `false` (not an Error) for disallowed origins — cors then simply
        // omits the CORS headers instead of throwing, which would otherwise leak
        // a stack trace to the client via Express's default error handler.
