 ...
 */
const PlushieMascot = () => (
    <div style={{ position: 'absolute', bottom: '15px', right: '-25px', zIndex: 60, transform: 'rotate(-3deg)', pointerEvents: 'none' }}>
        <div style={{ position: 'relative', width: '80px', height: '80px' }}>
            <svg viewBox="0 0 100 100" style={{ width: '100%', height: '100%', filter: 'drop-shadow(0 15px 20px rgba(0,0,0,0.12))' }}>
                ...
                <path d="M40 58 Q50 65 60 58" stroke="#4A351D" strokeWidth="4" fill="none" strokeLinecap="round" />
            </svg>
        </div>
    </div>
);
    ...
    return (
        <div style={{ minHeight: '100vh', background: '#FDFBFA', padding: '40px 10px 220px', display: 'flex', flexDirection: 'column', alignItems: 'center', overflow: 'hidden', touchAction: 'none' }}>
            ...
            <div style={{ position: 'relative', width: '100%', maxWidth: '390px' }}>
                ...
                {organizedData && (
                    <div style={{ position: 'absolute', top: '-25px', left: '0', right: '0', zIndex: 999, textAlign: 'center', animation: 'success-pop 0.5s cubic-bezier(0.175, 0.885, 0.32, 1.275)' }}>
                        <div style={{ display: 'inline-flex', flexDirection: 'column', alignItems: 'center', gap: '4px', backgroundColor: '#4A351D', color: '#D4AF37', padding: '15px 35px', borderRadius: '25px', fontWeight: '900', fontSize: '16px', boxShadow: '0 15px 50px rgba(0,0,0,0.4)', border: '2px solid #D4AF37' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                <Check size={24} strokeWidth={4} /> 「{organizedData.name}」を整理しました！
                            </div>
                ...
                <div style={{ height: '26px', width: '104%', marginLeft: '-2%', backgroundColor: '#FFF', border: '3px solid #F0EEE9', borderBottom: '6px solid #D1CDC0', borderRadius: '15px 15px 4px 4px' }}></div>
                <div style={{ backgroundColor: '#FFF', padding: '12px', border: '15px solid #FFF', borderTop: 'none', boxShadow: '0 60px 120px -30px rgba(0,0,0,0.22)', borderRadius: '0 0 25px 25px', display: 'flex', flexDirection: 'column', gap: '15px' }}>
            ...
            >
                ...
                <div style={{ backgroundColor: 'rgba(255,255,255,0.7)', backdropFilter: 'blur(10px)', borderRadius: '35px', padding: '30px', border: dragOverZone === 'unorganized-box' ? '4px solid #D4AF37' : '4px dashed #D1CDC0', minHeight: '180px', display: 'flex', flexWrap: 'wrap', gap: '20px', justifyContent: 'center' }}>
                    {sorted['unorganized']?.length > 0 ? sorted['unorganized'].map(item => {
                        ...
                        <div style={{ opacity: 0.3, textAlign: 'center', padding: '40px' }}><Star size={50} fill="#D4AF37" color="#D4AF37" /><p style={{ fontWeight: '900' }}>{t('allSorted')}</p></div>
                    )}
                </div>
            </div>
            ...
            <style dangerouslySetInnerHTML={{
                ...
                @keyframes magnetic-glow { 0% { opacity: 0.1; } 100% { opacity: 0.3; } }
