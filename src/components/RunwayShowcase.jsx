...
const RunwayShowcase = ({ items, t, onItemClick }) => {
    ...
    return (
        ...
        >
            ...
            {/* Floor */}
            <div style={{ position: 'absolute', bottom: '38px', left: 0, right: 0, height: '2px', background: 'rgba(255,255,255,0.25)' }} />

            {/* Floor glow tracking the walker */}
            <div
                key={`glow-${playKey}`}
                style={{
                    position: 'absolute', bottom: '32px', width: '90px', height: '16px',
            ...
            >
                <img
                    ...
                    style={{ width: '100%', height: '100%', objectFit: 'contain', filter: 'drop-shadow(0 6px 6px rgba(0,0,0,0.35))' }}
                />
            </div>
